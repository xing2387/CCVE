webpackJsonpjwplayer([1], {
        ...
        l = function(e, t, i, n) {
            ...
            return function() {
                ...
                return r(l, [{
                    key: "setup",
                    value: function() {
                        this.el = i.createElement((0, c["default"])(this.className, "jw-slider-" + this.orientation)),
                ...
                },
                {
                    ...
                    value: function() {
                        ...
                        this.railBounds = a(this.elementRail)
                    }
                },
                {
                    key: "dragEnd",
            ...
            return function() {
                ...
                },
                {
                    ...
                    value: function(e) {
                        ...
                        this.isOpen = !0,
                        i.toggleClass(this.el, this.openClass, this.isOpen)
                    }
                },
                {
                    key: "closeTooltip",
                ...
                c(r, [{
                    ...
                    value: function(e, o, a) {
                        ...
                        if (t.toggleClass(this.el, "jw-toggle", r || a.isToggle), t.toggleClass(this.el, "jw-button-color", !r), l) {
                            ...
                            c = t.createElement(s);
                            this.addContent(c),
                            this.contentUI = new n(this.content).on("click tap", this.selectListener)
    ...
    72 : function(e, t, i) {
        ...
        o = [i(4), i(5), i(3), i(22), i(2), i(1), i(70), i(126), i(128), i(127), i(132), i(131), i(129), i(130), i(175)],
        a = function(e, t, o, a, r, s, c, w, u, d, p, j, h, g, f) {
            ...
            return function() {
                ...
                return l(t, [{
                    ...
                    value: function(t, i) {
                        ...
                        s.className = "jw-controls jw-reset",
                        this.div = s;
                        ...
                        if (!this.displayContainer) {
                            ...
                            k.on("click tap",
                            function() {
                                l.trigger(e.JWPLAYER_DISPLAY_CLICK),
                                l.userActive(1e3),
                                t.play(y())
                            }),
                            r.isChrome() && !m && (k.el.style.pointerEvents = "none", k.icon.style.pointerEvents = "none"),
                            b.addButton(v),
                            b.addButton(k),
                            b.addButton(x),
                            this.div.appendChild(b.element()),
                            this.displayContainer = b
                        }
                        var C = this.context.createElement("div");
                        C.className = "jw-controls-right jw-reset",
                        s.appendChild(C),
                        this.right = C;
                        var _ = this.dock = new u(i);
                        this.right.appendChild(_.element()),
                        m ? r.addClass(this.playerContainer, "jw-flag-touch") : (this.rightClickMenu = new f, i.change("flashBlocked",
                        function(e, t) {
                            t ? l.rightClickMenu.destroy() : l.rightClickMenu.setup(e, l.playerContainer, l.playerContainer)
                        }));
                        var T = this.controlbar = new w(t, i);
                        if (T.on(e.JWPLAYER_USER_ACTION,
                        function() {
                            return l.userActive()
                        }), i.get("nextUpDisplay") && !T.nextUpToolTip) {
                            var E = new g(i, t, this.playerContainer);
                            E.on("all", this.trigger, this),
                            E.setup(this.context),
                            T.nextUpToolTip = E,
                            this.div.appendChild(E.element())
                        }
                        if (this.addActiveListeners(T.element()), this.div.appendChild(T.element()), i.get("autostartMuted")) {
                            var O = function() {
                                return l.unmuteAutoplay(t, i)
                            };
                            this.mute = c("jw-autostart-mute jw-off", O, i.get("localization").volume),
                            this.mute.show(),
                            this.div.appendChild(this.mute.element()),
                            T.renderVolume(!0, i.get("volume")),
                            r.addClass(this.playerContainer, "jw-flag-autostart"),
                            i.on("change:autostartFailed change:autostartMuted change:mute", O),
                            this.unmuteCallback = O
                        }
                        var M = function(e) {
                ...
                },
                {
                    ...
                    value: function() {
                        ...
                        this.div.parentNode && (r.removeClass(this.playerContainer, "jw-flag-touch"), this.playerContainer.removeChild(this.div)),
                        this.controlbar && this.removeActiveListeners(this.controlbar.element()),
                        this.rightClickMenu && this.rightClickMenu.destroy(),
                ...
                },
                {
                    ...
                    value: function(e, t) {
                        ...
                        this.unmuteCallback && (t.off("change:autostartFailed change:autostartMuted change:mute", this.unmuteCallback), this.unmuteCallback = null),
                        t.set("autostartFailed", void 0),
                        t.set("autostartMuted", void 0),
                        e.setMute(n),
                        this.controlbar.renderVolume(n, t.get("volume")),
                        this.mute.hide(),
                        r.removeClass(this.playerContainer, "jw-flag-autostart")
                    }
                },
                {
                ...
                },
                {
                    ...
                    value: function(e) {
                        ...
                        e || m),
                        this.showing || (r.removeClass(this.playerContainer, "jw-flag-user-inactive"), this.showing = !0, this.trigger("userActive"))
                    }
                },
                {
                    key: "userInactive",
                    value: function() {
                        clearTimeout(this.activeTimeout),
                        this.showing = !1,
                        this.controlbar && this.controlbar.closeMenus({
                            type: "userInactive"
                        }),
                        r.addClass(this.playerContainer, "jw-flag-user-inactive"),
        ...
        a = function(e, t, i) {
            ...
            return {
                ...
                drawCues: function() {
                    ...
                    return ! i || i <= 0 ? void this._model.once("change:duration", this.drawCues, this) : void e.each(this.cues,
                    function(e) {
                        e.align(i),
        ...
        s = function(e, t) {
            return function(e) {
                function i(e, n, l) {
                    ...
                    s = (0, d["default"])(l),
                    c = t.createElement(s);
                    return r.defaultIcon = c.getElementsByClassName("jw-menu-selection-icon")[0],
                    r.selectionText = c.getElementsByClassName("jw-menu-selection-text")[0],
                    r.el.insertBefore(c, r.container),
                    t.addClass(r.el, "jw-selection-menu"),
                    t.removeClass(r.el, "jw-icon"),
                    r
                }
                return l(i, e),
                c(i, [{
                    ...
                    value: function(e, n, o) {
                        this.list = e,
                        this.defaultIndex = o && o.defaultIndex > -1 ? o.defaultIndex: -1,
                        w(i.prototype.__proto__ || Object.getPrototypeOf(i.prototype), "setup", this).call(this, e, n, o),
                        t.addClass(this.el, "jw-button-color")
                    }
                },
                {
                    key: "selectItem",
                    value: function(e) {
                        ...
                        n && (this.selectionText.textContent = this.list[e].label),
                        t.toggleClass(this.defaultIcon, "jw-hidden", n),
                        t.toggleClass(this.selectionText, "jw-hidden", !n)
                    }
                }]),
                i
            } (e)
            ...
            return {
                ...
                loadThumbnail: function(t) {
                    ...
                    if (o > 0) try {
                        ...
                        i = a[1],
                        n.backgroundPosition = a[2] * -1 + "px " + a[3] * -1 + "px",
                        n.width = a[4],
                        n.height = a[5]
                    } catch(l) {
                        return
                    ...
                    return n.backgroundImage = 'url("' + i + '")',
                    n
                },
    ...
    124 : function(e, t, i) {
        ...
        l = [i(1), i(2), i(22), i(6), i(41), i(42), i(121), i(123)],
        r = function(e, t, i, l, r, w, u, d) {
            function p() {
                return {
                    reason: "interaction"
                }
            ...
            h = function(r) {
                function w(t, i) {
                    ...
                    return a._model = t,
                    a._api = i,
                    a.timeTip = new j("jw-tooltip-time", null, (!0)),
                    a.timeTip.setup(),
                    a.cues = [],
                    a.seekThrottled = e.throttle(a.performSeek, 400),
                ...
                c(w, [{
                    key: "setup",
                    value: function() {
                        s(w.prototype.__proto__ || Object.getPrototypeOf(w.prototype), "setup", this).apply(this, arguments),
                ...
                },
                {
                    ...
                    value: function(e) {
                        this.seekTo = e,
                        this.seekThrottled(),
                        s(w.prototype.__proto__ || Object.getPrototypeOf(w.prototype), "update", this).apply(this, arguments)
                    }
                },
                {
                    key: "dragStart",
                    value: function() {
                        ...
                        s(w.prototype.__proto__ || Object.getPrototypeOf(w.prototype), "dragStart", this).apply(this, arguments)
                    }
                },
                {
                    key: "dragEnd",
                    value: function() {
                        s(w.prototype.__proto__ || Object.getPrototypeOf(w.prototype), "dragEnd", this).apply(this, arguments),
                ...
                },
                {
                    ...
                    value: function(n) {
                        ...
                        if (0 !== o) {
                            ...
                            o < 0 && (w = o - w);
                            var u;
                            if ("touch" === l.getPointerType(n.sourceEvent) && (this.activeCue = e.reduce(this.cues,
                            function(e, t) {
                                ...
                                var d = !0;
                                u = t.timeFormat(w, d),
                                o < 0 && w > i.dvrSeekLimit && (u = "Live")
                            }
                            var p = this.timeTip;
                            p.update(u),
                            this.textLength !== u.length && (this.textLength = u.length, p.resetWidth()),
                            this.showThumbnail(w),
                            t.addClass(p.el, "jw-open");
                            var j = p.getWidth(),
                            h = r.width / 100,
                            g = a - r.width,
                            f = 0;
            ...
            return e.extend(h.prototype, u, d),
            h
        }.apply(t, l),
        ...
        r = function(e, t, i) {
            return function(e) {
                function l(e, a, r) {
                    ...
                    return s._model = e,
                    s.volumeSlider = new t("jw-slider-volume jw-volume-tip", "vertical"),
                    s.volumeSlider.setup(),
                    s.addContent(s.volumeSlider.element()),
                    s.volumeSlider.on("update",
                    function(e) {
                    ...
                    new i(s.el, {
                        useHover: !0,
                        directSelect: !0
                    }).on("click", s.toggleValue, s).on("tap", s.toggleOpenState, s).on("over", s.openTooltip, s).on("out", s.closeTooltip, s),
                    s._model.on("change:volume", s.onVolume, s),
                    s
                }
                return a(l, e),
                s(l, [{
    ...
    126 : function(e, t, i) {
        ...
        r = i(84);
        o = [i(2), i(1), i(3), i(22), i(6), i(64), i(41), i(124), i(71), i(122), i(125), i(70)],
        a = function(e, t, i, o, a, s, c, w, u, d, p, j) {
            function h(e, t) {
                var i = document.createElement("span");
                return i.className = "jw-text jw-reset " + e,
                t && i.setAttribute("role", t),
                i
            }
            function g(e, t) {
                return new u(e, t)
            ...
            function f(t, i) {
                ...
                o.className = "jw-button-color jw-icon-inline",
                s(o, n);
                var a = document.createElement("div");
                return a.className = "jw-reset jw-icon-cast",
            ...
            function y(e, i) {
                ...
                return n.className = "jw-group jw-controlbar-" + e + "-group jw-reset",
                t.each(i,
                function(e) {
            ...
            return function() {
                function s(l, u) {
                    ...
                    this._localization = u.get("localization"),
                    this.nextUpToolTip = null;
                    var b = new w(u, l),
                    v = void 0,
                    k = void 0,
                    ...
                    this._isMobile || (v = new c("jw-slider-volume", "horizontal"), v.setup(), k = new p(u, "jw-icon-volume", T)),
                    u.get("sdkplatform") || e.isIOS(8) || e.isIOS(9) || (x = j("jw-icon-volume", l.setMute, T));
                    ...
                    this.menus = t.compact([this.elements.hd, this.elements.cc, this.elements.audiotracks, this.elements.playbackrates, this.elements.volumetooltip]),
                    ...
                    this.elements.left = y("left", this.layout.left),
                    this.elements.center = y("center", this.layout.center),
                    this.elements.right = y("right", this.layout.right),
                    ...
                    u.change("volume", this.onVolume, this),
                    u.change("mute", this.onMute, this),
                    u.change("playlistItem", this.onPlaylistItem, this),
                    u.change("mediaModel", this.onMediaModel, this),
                    u.change("castAvailable", this.onCastAvailable, this),
                    u.change("castActive", this.onCastActive, this),
                    u.change("duration", this.onDuration, this),
                    u.change("position", this.onElapsed, this),
                    u.change("fullscreen", this.onFullscreen, this),
                    u.change("captionsList", this.onCaptionsList, this),
                    u.change("captionsIndex", this.onCaptionsIndex, this),
                    u.change("streamType", this.onStreamTypeChange, this),
                    u.change("nextUp", this.onNextUp, this),
                    u.change("cues", this.addCues, this),
                    u.change("altText", this.setAltText, this),
                    ...
                    this)),
                    this.elements.cast.button && new a(this.elements.cast.button).on("click tap",
                    function() {
                    ...
                    if (M) {
                        ...
                        u.change("streamType provider", this.togglePlaybackRateControls, this),
                        u.change("playbackRate", this.onPlaybackRate, this),
                        this.elements.playbackrates.on("select",
                        function(e) {
                            this._model.setPlaybackRate(M[e])
                        },
                        this),
                        this.elements.playbackrates.on("toggleValue",
                        function() {
                    ...
                    new a(this.elements.duration).on("click tap",
                    function() {
                    ...
                    this),
                    new a(this.elements.durationLeft).on("click tap",
                    function() {
                        if ("DVR" === this._model.get("streamType")) {
                            var e = this._model.get("position");
                    ...
                    this),
                    new a(this.el).on("click tap drag",
                    function() {
                ...
                },
                {
                    ...
                    value: function(e, i) {
                        ...
                        this),
                        i.on("change:currentLevel",
                        function(e, t) {
                            this.elements.hd.selectItem(t)
                        },
                        this),
                        i.on("change:audioTracks",
                        function(e, i) {
                            var n = t.map(i,
                            function(e) {
                                return {
                ...
                },
                {
                    ...
                    value: function(t, i) {
                        ...
                        this.elements.volumetooltip && (this.elements.volumetooltip.volumeSlider.render(t ? 0 : i), e.toggleClass(this.elements.volumetooltip.element(), "jw-off", t))
                    }
                },
                {
                    key: "onCastAvailable",
                ...
                },
                {
                    key: "onCastActive",
                    value: function(t, i) {
                        this.elements.fullscreen.toggle(!i),
                        this.elements.cast.button && e.toggleClass(this.elements.cast.button, "jw-off", !i)
                    }
                },
                {
                    key: "onElapsed",
                    value: function(t, i) {
                        ...
                        o = void 0,
                        a = t.get("duration");
                        "DVR" === t.get("streamType") ? n = o = "-" + e.timeFormat( - a) : (n = e.timeFormat(i), o = e.timeFormat(a - i)),
                ...
                },
                {
                    ...
                    value: function(t, i) {
                        var n = void 0;
                        n = "DVR" === t.get("streamType") ? "Live": e.timeFormat(i),
                        this.elements.duration.textContent = n,
                        this.elements.durationLeft.textContent = n
                    }
                },
                {
                    key: "onFullscreen",
                ...
                },
                {
                    ...
                    value: function() {
                        ...
                        i = e - 10,
                        n = 0;
                        "DVR" === this._model.get("streamType") && (n = t),
                        this._api.seek(Math.max(i, n), m())
                    }
                },
                {
                    ...
                    value: function(e) {
                        ...
                        "DVR" === t && (this.elements.duration.textContent = "Live", this.elements.durationLeft.textContent = "Live");
    ...
    127 : function(e, t, i) {
        ...
        l = function(e) {
            return function() {
                function t() {
                    o(this, t),
                    this.el = e.createElement((0, c["default"])()),
        ...
        l = function(e, t, i) {
            ...
            return function() {
                function l(t) {
                    ...
                    this.el = a(r),
                    new i(this.el).on("click tap", this.click, this),
                    this.model.on("change:dock",
                    function(t, i) {
                        var o = a(i);
                        e.emptyElement(n.el);
        ...
        l = function(e, t) {
            return function() {
                function i(n, a) {
                    ...
                    this.iconUI = new t(l).on("click tap",
                    function() {
                        a.next()
                    }),
                    n.change("nextUp",
            ...
            return function() {
                ...
                return r(l, [{
                    ...
                    value: function(e) {
                        ...
                        n.change("mediaModel", this.onMediaModel, this),
                ...
                },
                {
                    ...
                    value: function(t, i) {
                        if (this.enabled && (e.toggleClass(this.container, "jw-nextup-sticky", !!this.nextUpSticky), this.shown !== t)) {
                            this.shown = t,
                            e.toggleClass(this.container, "jw-nextup-container-visible", t),
                            e.toggleClass(this._playerElement, "jw-flag-nextup", t);
                ...
                },
                {
                    ...
                    value: function(t) {
                        ...
                        setTimeout(function() {
                            ...
                            i.header = i.content.querySelector(".jw-nextup-header"),
                            i.header.innerText = i.nextUpText,
                            i.title = i.content.querySelector(".jw-nextup-title");
                            var o = t.title;
                ...
                },
                {
                    ...
                    value: function(e, t) {
                        this.reset(),
                        t && (this.enabled = !(!t.title && !t.image), this.enabled && (t.showNextUp || (this.nextUpSticky = !1, this.toggle(!1)), this.setNextUpItem(t)))
                    }
                },
                {
                    key: "onDuration",
        ...
        l = function(e, t, i, n) {
            return function() {
                function a(l) {
                    ...
                    this.icon = u,
                    this.el = w,
                    this.iconUI = new i(this.el).on("click tap",
                    function(e) {
                        r.trigger(e.type)
                    }),
                    l.on("change:state",
    ...
    132 : function(e, t, i) {
        ...
        l = function(e, t) {
            return function() {
                function i(n, a) {
                    o(this, i),
                    this.el = e.createElement((0, c["default"])("rewind", n.get("localization").playback)),
                    this.iconUI = new t(this.el).on("click tap",
                    function() {
                        var e = n.get("position"),
                        t = n.get("duration"),
                        i = e - 10,
                        o = 0;
                        "DVR" === n.get("streamType") && (o = t),
                        a.seek(Math.max(i, o))
                    })
                }
                return r(i, [{
            ...
            return function() {
                ...
                },
                {
                    ...
                    value: function(e) {
                        ...
                        n = e.offsetY || e.layerY; t !== this.playerElement;) i += t.offsetLeft,
                        n += t.offsetTop,
                        t = t.parentNode;
                        return {
                            x: i,
                ...
                s(t, [{
                    ...
                    value: function() {
                        ...
                        if (this.model.get("abouttext")) {
                            e.items[0].showLogo = !1,
                            e.items.push(e.items.shift());
                            var i = {
